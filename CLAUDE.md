...
| 2026-06-23 | 트러스 설정 팝업 가로형 비주얼 피커 개편 (조립 미리보기·재고 도트, v0622-34~36) |
| 2026-06-23 | 3D 모델 라이브러리: 악기류·그외 카테고리 추가, 전 항목 삭제(암호 2375)·숨김/복원 (v0622-36~38) |
| 2026-06-23 | 평면도 흰 화면 버그 수정 (SVG XML 이스케이프·NaN 방어) (v0622-37) |
| 2026-06-23 | 평면도/내보내기 트러스 외 객체 1×1m 균일 위치마커 (v0622-39) |
| 2026-06-23 | 내보내기 등록 모델 실제 형상 복원 (박스만 나오던 문제) (v0622-40) |
| 2026-06-23 | .dae 내보내기 병렬 모델 로딩으로 멈춤 현상 해소 (v0622-41) |
| 2026-06-23 | 3D 도면 세팅 저장/불러오기 신설 (vehicle_data id=dae_setups 클라우드 동기화) (v0622-42) |
| 2026-06-23 | 등록 3D 모델 위치 어긋남 수정 — 재중심 매트릭스 적용 (v0622-43) |
